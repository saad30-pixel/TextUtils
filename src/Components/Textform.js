...
export default function Textform(props) {
  ...
  return (
    ...
    <div className="mb-3">
        <textarea className="form-control" style={{backgroundColor: props.mode==='dark'?'#305476':'#FFFAFA', color: props.mode==='dark'?'#FFFAFA':'#18191a'}} value={text} placeholder="Enter text here" onChange={handleOnChange} id="myBox" rows="8"></textarea>
    </div>
